...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(
			@RequestParam(value= "PageNumber", defaultValue= AppConstantsHardCodedValues.PAGENO,  required = false) Integer pageNumber,
			...
			@RequestParam(value= "sortDir", defaultValue= AppConstantsHardCodedValues.SORT_DIR ,  required = false) String sortDir
			)
	{
